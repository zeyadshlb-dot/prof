...
export default function AdminLayout({ children }) {
  ...
  return (
    <div
      dir="rtl"
      className="min-h-screen bg-background font-[family-name:var(--font-cairo)]"
    >
      {/* ==================== SIDEBAR ==================== */}
      {/* Desktop */}
      <aside
        ...
        <div className="relative flex flex-col h-full">
          ...
          >
            <div className="relative shrink-0">
              <div className="h-10 w-10 rounded-xl bg-linear-to-br from-violet-600 to-indigo-600 flex items-center justify-center shadow-lg shadow-violet-600/20">
              ...
              <div key={sectionKey} className="mb-4">
                ...
                <nav className="space-y-0.5">
                  {links.map((link) => {
                    ...
                    const badge =
                      link.countKey && counts[link.countKey] !== undefined
                        ? String(counts[link.countKey])
                        : undefined;
                      ...
                      <Link
                        ...
                        className={cn(
                          ...
                          collapsed
                            ...
                            : "gap-3 px-3 py-2.5",
                          active
                            ? "bg-linear-to-l from-violet-600 to-indigo-600 text-white shadow-md shadow-violet-600/15"
          ...
          <div className="border-t border-border/30 p-3">
            {collapsed ? (
              ...
              <div className="rounded-xl bg-linear-to-br from-accent/50 to-accent/20 p-3 border border-border/30">
                <div className="flex items-center gap-3">
                  <div className="h-9 w-9 rounded-xl bg-linear-to-br from-violet-600 to-indigo-600 flex items-center justify-center text-white font-bold text-sm shadow-sm shrink-0">
                    م
                  </div>
          ...
          <div className="absolute top-0 right-0 h-full w-[280px] bg-card dark:bg-[#111318] border-l border-border/40 shadow-2xl animate-in slide-in-from-right duration-300">
            ...
            <div className="flex items-center justify-between h-16 px-4 border-b border-border/30">
              <div className="flex items-center gap-2.5">
                <div className="h-9 w-9 rounded-xl bg-linear-to-br from-violet-600 to-indigo-600 flex items-center justify-center">
                  <GraduationCap className="h-5 w-5 text-white" />
                </div>
                      ...
                      return (
                        <Link
                          ...
                          className={cn(
                            ...
                            active
                              ? "bg-linear-to-l from-violet-600 to-indigo-600 text-white shadow-md"
                              : "text-muted-foreground hover:text-foreground hover:bg-accent/60",
                          )}
                        >
      ...
      >
        ...
        <header className="sticky top-0 z-40 h-16 flex items-center gap-3 px-4 lg:px-6 border-b border-border/40 bg-background/80 backdrop-blur-xl">
          ...
          <div className="flex items-center gap-1.5">
            ...
            {/* User Avatar */}
            <button className="h-9 w-9 rounded-xl bg-linear-to-br from-violet-600 to-indigo-600 flex items-center justify-center text-white font-bold text-xs shadow-sm hover:shadow-md hover:shadow-violet-600/20 transition-all">
              م
            </button>
          </div>
        </header>
